...
1. Pick one group member to [fork the front-end layer repo](https://github.com/Ada-c17/front-end-inspiration-board), and add everyone as collaborators.
1. Pick either the same or a different group member to [fork the back-end layer repo](https://github.com/Ada-c17/back-end-inspiration-board), and add everyone as collaborators.
